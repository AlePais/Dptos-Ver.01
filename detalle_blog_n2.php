<?php
	...
	$query = "SELECT * FROM `nivel_2` WHERE `n2_tipo` LIKE 'blog_nivel_2' AND `n2_corregido` LIKE '$n2_corregido'";
	$resultado = $mysqli->query($query);
	$contenido = $resultado->fetch_array(MYSQLI_ASSOC);

	$id_tabla1=$contenido['n1_id'];	$id_tabla2=$contenido['n2_id'];	$titulo = $contenido['n2_nombre'];	$descripcion = strip_tags($contenido['n2_descripcion']);
?>
<html>
	<head>
		<?php cabecera()?>
