<?php
	function listado_deptos($clausula, $mysqli, $raiz)
	{
		$query1 = "SELECT * FROM `nivel_1` NATURAL JOIN nivel_2 NATURAL JOIN nivel_3 WHERE $clausula GROUP BY nivel_3.n3_id ORDER BY nivel_3.n3_orden ";
