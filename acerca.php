...
<html>
	...
	<body> 
		...
		<div id="popup" style="display: none;" onclick="cerrar_popup();">
				<div id="imagenes" style="display: none;" onclick="cerrar_popup();">
							<center>
									<img id="imgsrc" src="../../interfaz/libros/sentir-lo-que-sentimos-portada.jpg">
			...
			<div class="<?php echo $clase1?>" style="<?php echo $fondo?>; background-color:<?php echo $secciones['fondo_rgba'];?>">
				<div class="<?php echo $clase2?>">
					...
					<?php
						...
						?>
						<span class="animated" ><?php echo $contenido;
						
							if($formulario==1)
							{
							include 'funciones/general/datos_mas_redes.php';
							}
						?></span>
						<div class="seccion_autoc"></div>
					...
					<script type="text/javascript">
					$(document).ready(function(){
					  $('#lista_<?php echo $id_seccion?>').slick({
