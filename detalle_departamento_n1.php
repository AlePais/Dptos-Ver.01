<?php
	...
	$id_elemento=$elemento['n1_id'];

	$query2 = "SELECT * FROM `archivo` WHERE `tabla_asociada` LIKE 'nivel_1' AND `id_elemento` = '$id_elemento' ORDER BY `orden`";
	...
	$titulo = $elemento['n1_nombre'];	$descripcion = strip_tags($elemento['n1_descripcion']);
?>
<html>
	<head>
		<?php cabecera()?>
			...
			<div class="seccion_g2 left  seccion_auto margin_principal" style="background-image:url(<?php echo $imagen?>)">
				<div class="ancho_fijo_auto ">
					<div class="seccion_auto transparente_negro columna_2 ">
						<h1><?php echo $elemento['n1_nombre'];?></h1>
						<?php echo $elemento['n1_descripcion'];?>
				...
				<div class="ancho_fijo_auto ">
					...
					<div  class="columna_1 right seccion_auto margin_principal">
						<?php
							...
							$id_consulta =  $elemento['n1_id'];
							$clausula = "nivel_3.n3_tipo = 'departamento_nivel_3' AND nivel_3.n1_id = '$id_consulta'";
