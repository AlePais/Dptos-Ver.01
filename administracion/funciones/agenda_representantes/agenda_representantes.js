...
function agregar()
{
	...
	({
		type: "POST",
		url: 'funciones/agenda_representantes/relacion_crear.php',
...
function quita_relacion(id)
{
	...
	conexion1.open('GET','funciones/agenda_representantes/relacion_eliminar.php?id_relacion='+id, true);
	conexion1.send(null);
}
...
function lista_relaciones()
{
	...
	({
		type: "POST",
		url: 'funciones/agenda_representantes/relacion_listar.php',
		data: $("#formulario").serialize(), // Adjuntar los campos del formulario enviado.
		success: function(respuesta)
		{
